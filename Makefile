...
GO_MODULE := github.com/dziunincode69/gopassafe-proto
...
.PHONY: protoc-go
protoc-go:
	protoc --go_opt=module=${GO_MODULE} --go_out=./protogen  \
	--go-grpc_opt=module=${GO_MODULE} --go-grpc_out=./protogen \
	./proto/user/*.proto ./proto/vault/*.proto
